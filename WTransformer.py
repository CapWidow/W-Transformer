...
if __name__ == "__main__":
    ...
    for nforecast in nforecastList:
        ...
        # in the folder
        path = 'C:/Users/Admin/ResearchW/MODWT/Data/Weekly'
        csv_files = glob.glob(os.path.join(path, "*.csv"))
        # loop over the list of csv files
        for f in csv_files:
            with open('Result_13_26_52_MODWT_NFLX.csv', 'a', encoding='UTF8') as r:
                writer = csv.writer(r)
            ...
            with open('Result_13_26_52_MODWT_NFLX.csv', 'a', encoding='UTF8') as f:
                writer = csv.writer(f)
